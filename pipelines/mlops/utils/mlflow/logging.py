...
def track_experiment(
    ...
    model: Optional[Union[BaseEstimator, Booster]] = None,
    ...
    verbosity: Union[bool, int] = True,  # False by default or else it creates too many logs
    **kwargs,
) -> Run:
    experiment_name = experiment_name or DEFAULT_EXPERIMENT_NAME
    ...
    if not run_name:
        run_name = ':'.join([str(s) for s in [pipeline_uuid, partition, block_uuid] if s])
