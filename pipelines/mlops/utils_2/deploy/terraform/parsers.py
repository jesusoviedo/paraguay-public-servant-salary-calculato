...
from mlops.utils_2.deploy.terraform.constants import TERRAFORM_AWS_FULL_PATH


def build_parser(resource_type: str):
    """
    data_type:
            "data"
            "resource"
    ...
    resource_name:
        ...
        "env_vars"
    configuration_block: block start with "name" { ... }
        image_scanning_configuration
        lifecycle
    attribute_name: attributes start with "name" = "value" or { ... }
        tags
    """
    pass
